package com.chowyijiu.boot.mbp.controller;
...
public class EmployeeController {
    ...
    public String getAllEmployee(Model model) {
        ...
        Page<Employee> page = employeeService.page(new Page<>(1, 5));
        //将员工信息在请求域中共享
    ...
    public String getEmployeePage(@PathVariable("pageNo") Integer pageNo, Model model) {
        ...
        Page<Employee> page = employeeService.page(new Page<>(pageNo, 5));
        //将分页数据,共享到请求域中
        model.addAttribute("page", page);
...
//        Integer lastPageNo = (Integer) getPages.invoke(obj);
    ...
    public String deleteEmployee(@PathVariable("pageNum") Integer pageNum, @PathVariable("empId") Integer empId) {
        ...
        Page<Employee> page = employeeService.page(new Page<>(pageNum, 5));
